...
void GyroTurn(double target)
{
  ...
  while(currentAngle < (target - tolerance) || currentAngle > (target + tolerance))
  {
    if (millis()-previous_millis > 50)
    {
      ...
      left_font_motor.writeMicroseconds(1500 - saturation(100+speed_value));
      left_rear_motor.writeMicroseconds(1500 - saturation(100+speed_value));
      right_rear_motor.writeMicroseconds(1500 - saturation(100+speed_value));
      right_font_motor.writeMicroseconds(1500 - saturation(100+speed_value));
